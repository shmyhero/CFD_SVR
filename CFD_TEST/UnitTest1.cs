...
namespace CFD_TEST
{
    ...
    public class UnitTest1
    {
        ...
        public void YunPianSMS()
        {
            ...
            List<string> mobiles = new List<string>() { "13764349804", "13911732034", "13524574698" };
            List<string> coupons = new List<string>() { "st5CJV11312072JV", "st5ELY11312095LR", "st4AKU11312118MU" };
