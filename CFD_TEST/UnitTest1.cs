...
namespace CFD_TEST
{
    ...
    public class UnitTest1
    {
        ...
        public void YunPianSMS()
        {
            ...
            List<string> mobiles = new List<string>() { "13989389572", "13818076317", "13699817331" };
            List<string> coupons = new List<string>() { "st9GJW11311796MQ", "st6CKR11311819KV", "st7EKW11311842KY" };
