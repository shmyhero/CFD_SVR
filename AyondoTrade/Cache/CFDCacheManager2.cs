...
{
    internal sealed class CFDCacheManager2
    {
        private static readonly Lazy<CFDCacheManager2> instance = new Lazy<CFDCacheManager2>(() => new CFDCacheManager2());
        ...
        public static CFDCacheManager2 Instance { get { return instance.Value; } }

        private CFDCacheManager2()
        {
        }
            ...
            Task.Factory.StartNew(
                () => {
                    ...
                    if(cfdCache.Contains(openPositionCachePrefix + account))
                    {
                        ...
                        cfdCache.Set(openPositionCachePrefix + account, null, policy);
                    }
                });
        }
        ...
        public IList<PositionReport> GetOpenPosition(string account)
        {
            ...
            if (cfdCache.Contains(openPositionCachePrefix + account))
            {
                return cfdCache[openPositionCachePrefix + account] as IList<PositionReport>;
            }
